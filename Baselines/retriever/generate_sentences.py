...
def generate_output_files(data, index):
    with open('tsdae_without_bginfo/{}_{}.source'.format(out, index), 'w', encoding='utf-8') as source:
        print('tsdae_without_bginfo/{}_{}.source'.format(out, index))
        with open('tsdae_without_bginfo/{}_{}.target'.format(out, index), 'w',
                  encoding='utf-8') as target:
            print('tsdae_without_bginfo/{}_{}.target'.format(out, index))
...
if __name__ == '__main__':
    ...
    sources, targets = generate_output_files(dataslice, index)
    save_to_json(sources, 'tsdae_without_bginfo/trainsource_0.json')
    save_to_json(targets, 'tsdae_without_bginfo/traintarget_0.json')
